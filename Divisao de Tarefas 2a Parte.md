...
- **Implementação das páginas em XAML**: Converter o **HTML/CSS** para **XAML** e integração ao **.NET MAUI**.    

## Guilherme Lima Moreira  
- **Banco de Dados**: Implementação do banco de dados **SQLite** compatível com **.NET MAUI**.
- Desenvolveu a parte lógica em **C#** para integrar ao banco de dados.
